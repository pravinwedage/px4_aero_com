...
"""autogenerated by genpy from px4_command/SinglePayloadActionRequest.msg. Do not edit."""
import codecs
import sys
...
class SinglePayloadActionRequest(genpy.Message):
  ...
  _type = "px4_command/SinglePayloadActionRequest"
...
def _get_struct_Bi():
    ...
    return _struct_Bi
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from px4_command/SinglePayloadActionResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SinglePayloadActionResponse(genpy.Message):
  ...
  _type = "px4_command/SinglePayloadActionResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class SinglePayloadAction(object):
  _type          = 'px4_command/SinglePayloadAction'
