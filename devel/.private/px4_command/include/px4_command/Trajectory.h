...
struct Trajectory_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::px4_command::TrajectoryPoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::px4_command::TrajectoryPoint_<ContainerAllocator> >> _points_type;
  _points_type points;
...
bool operator==(const ::px4_command::Trajectory_<ContainerAllocator1> & lhs, const ::px4_command::Trajectory_<ContainerAllocator2> & rhs)
{
